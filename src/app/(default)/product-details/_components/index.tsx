          ...
          <div className="space-y-6">
            <div className="pt-2">
              <h1 className="text-3xl font-bold text-gray-800 mb-6">
                লিচু ফুলের মধু ২ কেজি (Litchi Flower Honey 2kg)
              </h1>
              ...
              <p className="text-gray-700">
                লিচু ফুলের মধুতে থাকা ঔষুধী গুণাগুণ সাধারণত কোষ্ঠকাঠিন্য দূর
                করতে, ফুসফুসের যাবতীয় রোগ ও শ্বাসকষ্ট নিরাময়ে, মুখগহ্বরের
                স্বাস্থ্য রক্ষায়, হজম শক্তি বৃদ্ধি সহ ত্বকের সৌন্দর্য বৃদ্ধিতে,
                ওজন কমাতে, এবং রক্তশূন্যতা দূর করতে কার্যকরী ভূমিকা রাখে।
                পুষ্টিগুণে অতুলনীয় সুস্বাদু এই লিচু ফুলের মধু।
              </p>
            </div>
