    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <Card className="shadow-none px-8 py-12 rounded-sm">
            <CardHeader>
        ...
        {/* Google Maps */}
        <Card className="shadow-none px-8 py-12 mt-10 rounded-sm">
          <CardHeader className="px-0">
            <CardTitle>Find us</CardTitle>
            <CardDescription>Visit our office location</CardDescription>
          </CardHeader>
          <CardContent className="p-0">
            <div className="w-full h-90 bg-muted rounded-b-lg overflow-hidden">
              <iframe
